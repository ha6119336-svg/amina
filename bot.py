...
REMINDER_TIME_1 = dt_time(12, 50)
REMINDER_TIME_2 = dt_time(17, 0)
REMINDER_TIME_3 = dt_time(21, 0)

# --- النصوص ---
GENERAL_DHIKR = """ 🔴 أربع سنن في أول ليلة من رمضان 

1⃣ تبييت النية الصيام
قال ﷺ: «من لم يُبيِّت الصيام من الليل فلا صيام له» رواه النسائي
والنية لا تلفظ بل محلها القلب
قال شيخ الإسلام ابن تيمية: «ومن خطر بقلبه أنه صائم غدا فقد نوى». انتهى.

2⃣ الدعاء إذا رأيت الهلال
كان ﷺ إذا رأى الهلال قال:
«اللهم أهلَّه علينا بالأمن والإيمان، والسلامة والإسلام، ربنا وربك الله».

3⃣ صلاة التراويح
قال ﷺ: «من قام رمضان إيمانًا واحتسابًا غُفر له ما تقدم من ذنبه».

4⃣ السحور
قال ﷺ: «السحور أكلة بركة فلا تدعوه، ولو أن يجرع أحدكم جرعة من ماء، فإن الله وملائكته يصلون على المتسحرين».
"""
