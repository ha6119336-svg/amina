...
REMINDER_TIME_1 = dt_time(9, 11)
REMINDER_TIME_2 = dt_time(17, 0)
REMINDER_TIME_3 = dt_time(21, 0)

# --- النصوص ---
GENERAL_DHIKR = """كان النبي ﷺ يُبشر أصحابه برمضان ويقول: جاءكم شهر رمضان، شهرٌ مباركٌ، شهرٌ تُحطُّ فيه الخطايا، ويُجاب فيه الدعاء، فأروا الله من أنفسكم خيرًا، فإنَّ الشَّقي مَن حُرم رحمة الله، ويقول ﷺ: مَن صام رمضان إيمانًا واحتسابًا غُفر له ما تقدَّم من ذنبه، ومَن قامه إيمانًا واحتسابًا غُفر له ما تقدَّم من ذنبه.
"""
